...
import 'package:screen_sizer/base/country_code_picker.dart';
import 'package:screen_sizer/base/color_data.dart';
import 'package:screen_sizer/base/resizer/fetch_pixels.dart';

import '../app/models/model_discover.dart';
import '../app/models/model_trending.dart';
...
Container topCollectionListItem(
    BuildContext context, ModelTrending modelTrend, int index, bool isLast) {
  double imgSize = FetchPixels.getPixelHeight(61);
  double radius = FetchPixels.getPixelHeight(12);
  double verSpace = FetchPixels.getPixelHeight(16);
  return Container(
    ...
    child: Column(
      children: [
        ...
        // getVerSpace((index == 0) ? verSpace : verSpace / 2),
        Row(
          children: [
            getCircularImage(
                context, imgSize, imgSize, radius, modelTrend.image,
                boxFit: BoxFit.cover),
                ...
                children: [
                  Row(
                    children: [
                      Expanded(
                        child: getCustomFont(
                            modelTrend.title, 15, getFontColor(context), 1,
                            fontWeight: FontWeight.w600),
                        flex: 1,
                      ),
                      getSvgImageWithSize(
                      ...
                      getHorSpace(FetchPixels.getPixelHeight(8)),
                      getCustomFont(
                          modelTrend.amount, 13, getFontColor(context), 1,
                          fontWeight: FontWeight.w600)
                    ],
                    mainAxisAlignment: MainAxisAlignment.center,
                    crossAxisAlignment: CrossAxisAlignment.center,
                  ...
                  Row(
                    children: [
                      Expanded(
                        child: getCustomFont(
                            modelTrend.subTitle, 13, getFontSkip(context), 1,
                            fontWeight: FontWeight.w400),
                        flex: 1,
                      ),
                      getCustomFont(
                          modelTrend.discount, 13, modelTrend.discountColor, 1,
                          fontWeight: FontWeight.w400)
                    ],
                    mainAxisAlignment: MainAxisAlignment.center,
                    crossAxisAlignment: CrossAxisAlignment.center,
...
Column buildDiscoverItem(BuildContext context, ModelDiscover modelDiscover,
    double horSpace, int crossAxisCountPopular, double gridWidth) {
  return Column(
    children: [
      InkWell(
        child: Container(
          ...
          child: Column(
            children: [
              Row(
                ...
                crossAxisAlignment: CrossAxisAlignment.center,
                children: [
                  getCircleImage(context, modelDiscover.profile,
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        getCustomFont(
                            modelDiscover.name, 16, getFontColor(context), 1,
                            fontWeight: FontWeight.w600),
                        getVerSpace(FetchPixels.getPixelHeight(4)),
                        getCustomFont(modelDiscover.profileDes, 16,
                  ...
                  Container(
                    child: Row(
                      ...
                      children: [
                        ...
                        getCustomFont("1.5K", 14, getFontSkip(context), 1,
                            fontWeight: FontWeight.w600)
                      ],
                    ),
              ...
              getCircularImage(
                  context,
                  double.infinity,
                  FetchPixels.getPixelHeight(266),
              ...
              Row(
                ...
                children: [
                  ...
                  getHorSpace(FetchPixels.getPixelHeight(8)),
                  getCustomFont(
                      modelDiscover.amount, 16, getFontColor(context), 1,
                      fontWeight: FontWeight.w600),
                ],
              ),
              getVerSpace(FetchPixels.getPixelHeight(9)),
              getCustomFont(modelDiscover.duration, 16, getFontSkip(context), 1,
                  fontWeight: FontWeight.w500),
            ],
            mainAxisAlignment: MainAxisAlignment.start,
            crossAxisAlignment: CrossAxisAlignment.start,
          ),
          height: FetchPixels.getPixelHeight(436),
          decoration: getButtonDecoration(
        ...
        onTap: () {
          Constant.sendToNext(context, Routes.discoverDetailRoute);
        },
      ),
      GridView.count(
        padding: EdgeInsets.symmetric(horizontal: horSpace / 2),
        crossAxisCount: crossAxisCountPopular,
        childAspectRatio: gridWidth / gridWidth,
        shrinkWrap: true,
        primary: false,
        children: List.generate(modelDiscover.imageList.length, (index1) {
          return Center(
            child: Container(
              width: gridWidth,
              height: gridWidth,
              ...
              child: Stack(
                children: [
                  Padding(
                    padding:
                        EdgeInsets.all(Constant.getPercentSize(gridWidth, 8)),
                    child: getCircularImage(
                        context,
                        double.infinity,
                        double.infinity,
                        FetchPixels.getPixelHeight(12),
                        modelDiscover.imageList[index1]),
                  ),
                  Visibility(
                    child: Padding(
                        padding: EdgeInsets.only(
                            left: horSpace + FetchPixels.getPixelWidth(10),
                            top: Constant.getPercentSize(gridWidth, 5),
                            bottom: Constant.getPercentSize(gridWidth, 5)),
                        child: Container(
                          child: getCustomFont("New", 15, Colors.white, 1),
                          decoration: getButtonDecoration(purpleColor,
                              withCorners: true,
                              withBorder: false,
                              corner: FetchPixels.getPixelHeight(14)),
                          padding: EdgeInsets.symmetric(
                              horizontal: FetchPixels.getPixelWidth(8.5),
                              vertical: FetchPixels.getPixelHeight(5.5)),
                        )),
                    visible: (index1 == 0),
                  )
                ],
